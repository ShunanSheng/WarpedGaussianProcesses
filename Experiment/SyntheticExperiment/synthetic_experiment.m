...
%% save results
save(file_name, 'aveMSE', 'aveF1','aveTPR','aveFPR')

%% Analyze the effects of the noise variance on F1 score, MSE, TPR, and FPR
N = 20;
...
%% Compare the ROC curve when K = M = 64 for WGPLRT and NRLT
sn = 0.1;
cell_TPR = cell(1, 2);
cell_FPR = cell(1, 2);
K = 64;
